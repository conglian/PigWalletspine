...
android {
    namespace = "com.example.piggywalletspinearn"
...
//
//    // Bidmachine
//    api("com.thinkup.sdk:adapter-tpn-bidmachine:6.5.36")
//    api("io.bidmachine:ads:3.3.0")
//
//    // Chartboost
//    api("com.thinkup.sdk:adapter-tpn-chartboost:6.5.36.4")
//    api("com.chartboost:chartboost-sdk:9.10.2")
